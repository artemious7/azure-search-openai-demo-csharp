...
");
        ...
        async Task<SupportingImageRecord[]?> RetrieveImagesIfVisionServiceIsAvailable(RequestOverrides? overrides, string question, string? query, SupportingImageRecord[]? images, CancellationToken cancellationToken)
        {
        ...
        async Task<(OpenAIPromptExecutionSettings promptExecutingSetting, string ans, string thoughts)> PutTogetherRelatedDocsAndConversationHistoryToGenerateAnswer()
        {
...
{{
    ...
    ""thoughts"": // brief thoughts on how you came up with the answer, e.g. what sources you used, what you thought about, etc.
            ...
            return (promptExecutingSetting, ans, thoughts);
        }
